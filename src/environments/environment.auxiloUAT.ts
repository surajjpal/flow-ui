export const environment = {
    ...
    // Root
    root: 'https://demo-flow.auxilofinance.in/flow/',

    // API
    authurl: 'https://demo-flow.auxilofinance.in/flow/auth/',

    // Services
    saveaccounturl: 'https://demo-flow.auxilofinance.in/flow/account/create',
    fetchaccountbyidurl: 'https://demo-flow.auxilofinance.in/flow/account/',
    publishaccounturl: 'https://demo-flow.auxilofinance.in/flow/account/publish/',
    unpublishaccounturl: 'https://demo-flow.auxilofinance.in/flow/services/unpublish/',



    // Interfaces
    interfaceService: 'https://demo-flow.auxilofinance.in/flow/interfaces',
    updateClassifierTraining: 'https://demo-flow.auxilofinance.in/flow/interfaces/auto_decorate_training',
    updateIntentTraining: 'https://demo-flow.auxilofinance.in/flow/interfaces/intent_classification_training',
    updateEntityTraining: 'https://demo-flow.auxilofinance.in/flow/interfaces/entity_classification_training',

    // Flow
    server: 'https://demo-flow.auxilofinance.in/flow/console/',
    ...
    // auto
    autoServer: 'https://demo-flow.auxilofinance.in/flow/auto/',
    ...
    // Analytics
    reportservice: 'https://demo-flow.auxilofinance.in/flow/report',
    ...
    //Dashboard
    dashboardServer: 'https://demo-flow.auxilofinance.in/flow/dashboard/',
    ...
    dashboardinterface: 'https://demo-flow.auxilofinance.in/flow/interfaces/dashboard',
    ...
    sendReportCSV: 'https://demo-flow.auxilofinance.in/flow/report/reports/generatereport',


    //Vocabulary
    vocabulary: 'https://demo-flow.auxilofinance.in/flow/interfaces/vocabulary',
